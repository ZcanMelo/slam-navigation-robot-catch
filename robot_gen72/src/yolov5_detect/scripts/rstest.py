...
import sys
import rospy
from yolov5_detect.msg import DetectedObject
from std_msgs.msg import String
sys.path.append("/home/nvidia/robot_gen72/src/yolov5_detect/scripts")
sys.path.append("/home/nvidia/anaconda3/envs/Yolov5/lib/python3.8/site-packages")
...
class YoloV5:
    def __init__(self, yolov5_yaml_path='/home/nvidia/robot_gen72/src/yolov5_detect/scripts/config/yolov5s.yaml'):
        '''初始化'''
        # 载入配置文件
...
if __name__ == '__main__':
    ...
    model = YoloV5(yolov5_yaml_path='/home/nvidia/robot_gen72/src/yolov5_detect/scripts/config/yolov5s.yaml')
        ...
        while not rospy.is_shutdown():
            ...
            if xyxy_list:
                for i in range(len(xyxy_list)):
                    ...
                    detected_object.x = camera_xyz[0]
                    detected_object.y = camera_xyz[1]
                    detected_object.z = camera_xyz[2]
        # 使用publisher发布消息
